      ...
      <div className="site-container">
        <div className="section-head">
          ...
          <h2 className="section-title">
            A more editorial, premium case-study section with a distinct chapter feel.
          </h2>
          <p className="section-text">
            This section is intentionally styled to feel different from Services so users feel they
            have entered a new story layer.
          </p>
        </div>

        <div className="work-controls work-controls-centered">
          <button className="work-btn" onClick={prev} aria-label="Previous project">
            <ArrowLeft className="h-5 w-5" />
          </button>
          <button className="work-btn" onClick={next} aria-label="Next project">
        ...
        <div className="work-stage premium-work-stage">
          {projects.map((project, index) => (
            <article
              key={project.title}
              className={`work-card premium-work-card ${
                index === active ? "work-card-active" : ""
              }`}
            >
              <div className="work-visual premium-work-visual">
                <div className="work-screen-shell">
                  <div className="work-screen-header">
                    <span />
                    <span />
                    <span />
                  </div>
                  ...
                  <div className="work-screen-body">
                    ...
                    <div className="work-ui-row">
                      <div className="work-ui-block" />
                      <div className="work-ui-block" />
                    </div>

                    <div className="work-ui-row">
                      <div className="work-ui-block small" />
                      <div className="work-ui-block small" />
                      <div className="work-ui-block small" />
                    </div>
                  </div>
